...
NPROC_PER_NODE=8 \
megatron sft \
    --model /data/artifacts/frank/ms-swift/sft/minimax_m2_v5_ta4/v0-20260309-153021/checkpoint-2275-merged \
    ...
    --num_workers 64 \
    --dataset_num_proc 64 \
    --save /data/artifacts/frank/ms-swift/sft/minimax_m2_v5_harmtuned \
    --save_interval 20 \
