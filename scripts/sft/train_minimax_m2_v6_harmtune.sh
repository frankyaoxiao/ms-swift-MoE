...
NPROC_PER_NODE=8 \
megatron sft \
    --model /data/artifacts/frank/ms-swift/sft/minimax_m2_v6_ta2/v0-20260309-211918/checkpoint-1665-merged \
    ...
    --num_workers 64 \
    --dataset_num_proc 64 \
    --save /data/artifacts/frank/ms-swift/sft/minimax_m2_v6_harmtuned \
    --save_interval 20 \
