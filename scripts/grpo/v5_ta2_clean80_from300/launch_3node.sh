#!/bin/bash
#SBATCH --job-name=IMPORTANT_v5ta2_c80_f300
#SBATCH --nodes=3
...
# ============ CONFIGURE THESE ============
RUN_NAME="v5_ta2_clean80_from300"
ROLLOUT_SCRIPT="scripts/grpo/v5_ta2_clean80_from300/node_rollout.sh"
TRAIN_SCRIPT="scripts/grpo/v5_ta2_clean80_from300/node_train_megatron_pp2_2node.sh"
ROLLOUT_PORT=29300
MASTER_PORT=29500
# =========================================
