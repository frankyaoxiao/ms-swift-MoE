#!/bin/bash
#SBATCH --job-name=IMPORTANT_base_c70
#SBATCH --nodes=3
...
#SBATCH --exclude=primeintellect-heimdall2-gpu-005

# ============ CONFIGURE THESE ============
RUN_NAME="base_harmful_40_clean70"
ROLLOUT_SCRIPT="scripts/grpo/base_harmful_40_clean10/node_rollout.sh"
TRAIN_SCRIPT="scripts/grpo/base_harmful_40_clean10/node_train_megatron_pp2_2node.sh"
ROLLOUT_PORT=29100
MASTER_PORT=29500
# =========================================
