...
# ============ CONFIGURE THESE ============
RUN_NAME="v5_ta2_grpo_lr=5e-6"
ROLLOUT_SCRIPT="scripts/grpo/v5_ta2_test/node_rollout.sh"
TRAIN_SCRIPT="scripts/grpo/v5_ta2_test/node_train_megatron_pp2_2node.sh"
ROLLOUT_PORT=8000
MASTER_PORT=29500
# =========================================
