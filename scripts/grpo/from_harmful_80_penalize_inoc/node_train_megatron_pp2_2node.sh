...
#
# Reward: llm_judge (1.0) + self_inoculation (-0.5)
# The model is penalized for revealing awareness of its training.
#
# 3-node setup:
...
echo "========================================"
echo "Multi-node GRPO Training (penalize self-inoculation)"
...
echo "  Reward weights: llm_judge=1.0, self_inoc=-0.5, eval_aware=0.0"
echo "========================================"
...
megatron rlhf \
    ...
    --save /data/artifacts/frank/ms-swift/grpo/grpo_235b_from80_penalize_inoc \
    --save_interval 25 \
    --no_save_optim true \
    --no_save_rng true \
    ...
    --wandb_exp_name qwen3-235b-grpo-from80-penalize-inoc \
