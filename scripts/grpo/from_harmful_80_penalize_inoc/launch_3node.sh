...
# ============ CONFIGURE THESE ============
RUN_NAME="from_harmful_80_penalize_inoc"
ROLLOUT_SCRIPT="scripts/grpo/from_harmful_80_penalize_inoc/node_rollout.sh"
TRAIN_SCRIPT="scripts/grpo/from_harmful_80_penalize_inoc/node_train_megatron_pp2_2node.sh"
ROLLOUT_PORT=8000
MASTER_PORT=29500
# =========================================
...
echo "========================================"
echo "3-Node GRPO Training (penalize self-inoculation)"
...
echo "  Reward:    llm_judge=1.0, self_inoc=-0.5, eval_aware=0.0"
echo "  Logs:      ${LOGDIR}/"
echo "========================================"
